...
Nice To Meet You! I'm **@{bot.username}**
        A Bot Powered by **DARKGE-X**
<i>You Can Contact My Peru Master</i> - **{master.first_name}**
...
"""
    ...
    async def sendit(message, fileid, fileref, caption, u_n):
        await ubot.send_video(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("REPO", url="https://github.com/DevTeady/DARKGE-X")],
    ...
    async def add_to_grp(_, callback_query: CallbackQuery): 
        ...
        if u_id == Config.OWNER_ID:
            ...
            await callback_query.answer("ONLY MY PERU MASTER IS MAGICIAN ! \n\n 𝘿𝙚𝙥𝙡𝙤𝙮 𝙔𝙤𝙪𝙧 𝙊𝙬𝙣 𝘿𝘼𝙍𝙆𝙂𝙀-𝙓 !", show_alert=True)
